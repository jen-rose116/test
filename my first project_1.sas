...
DATE: Thursday, December 04, 2014     TIME: 2:24:36 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, December 04, 2014 at 2:24:31 PM
...
/*   START OF NODE: Summary Statistics for Age & Smoking Qty   */
%LET _CLIENTTASKLABEL='Summary Statistics for Age & Smoking Qty';
%LET _CLIENTPROJECTPATH='Z:\PSYC\LDierker\JROSE01\big data courses\data management\EG demo project\my first project_1.egp';
%LET _CLIENTPROJECTNAME='my first project_1.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, December 04, 2014 at 2:24:31 PM
   By task: Summary Statistics for Age & Smoking Qty
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
TITLE;
TITLE1 "Summary Statistics for Age";
TITLE2 "Results";
FOOTNOTE;
FOOTNOTE1 "Generated by the SAS System (&_SASSERVERNAME, &SYSSCPL) on %TRIM(%QSYSFUNC(DATE(), NLDATE20.)) at %TRIM(%SYSFUNC(TIME(), TIMEAMPM12.)) by Jennifer Rose";
